...
Search:			CBZ W6, Prep		// Se não houver mais círculos a procurar, volta ao loop para buscar o próximo ponto.
...
Prep:			ADD X4, X4, #4		// Preparação para ir buscar o próximo valor. Apenas aumentar o endereço X4 4 bytes, para ir para o próximo inteiro de ID.
				B Loop

Finish: 		RET					// Retorna. Void function, pois X0 não interessa para o resultado atual.